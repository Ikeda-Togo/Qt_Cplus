...
QT_MOC_LITERAL(3, 25, 12), // "start_thread"
QT_MOC_LITERAL(4, 38, 11), // "stop_thread"
QT_MOC_LITERAL(5, 50, 9) // "q_counter"

    },
    "HelloWorld\0countChanged\0\0start_thread\0"
    "stop_thread\0q_counter"
};
...
void HelloWorld::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (HelloWorld::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HelloWorld::countChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< int*>(_v) = _t->_counter; break;
        default: break;
        }
        ...
        switch (_id) {
        case 0:
            if (_t->_counter != *reinterpret_cast< int*>(_v)) {
                _t->_counter = *reinterpret_cast< int*>(_v);
                Q_EMIT _t->countChanged();
            }
            break;
        default: break;
        }
